...
//    String data = HttpClient3.doGet("");
//    System.out.println(data);
    Map<String, Object> parames = new HashMap<String, Object>();

//    parames.put("platform", "2");
//    parames.put("appVersion", "1.7.0");
    parames.put("tempr", 92);
    String data1 = HttpClient3.doPost("http://teknosains.com/article/updateCounter", parames);
